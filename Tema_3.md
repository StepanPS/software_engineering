...
В данном коде выводиться: длина предложения, предложение в нижнем регистре, подсчитаное количество гласных (а, е, і, о, и) в предложении, заменяет все слова "ugly" на "beauty", сообщение о результате проверки: начинается ли предложение с "The" и заканчивается ли на "end". Код получился самым объёмным из пятёрки и каждая строка в той или иной степени отличается друг от друга :
